...
Users who wish to join a P2P cluster, need to create a
[pico.sh](https://pico.sh/) account, which gives them access to the task
message board. In contrast, P2P file transfers that take place between
clients and workers are anonymous and require no accounts.
...
very convenient way of working with SSH. You can read more about it in
the Wikibooks article [‘OpenSSH/Cookbook/Public Key
...
authenticate once when you log into your computer, instead of at each
SSH connection.
